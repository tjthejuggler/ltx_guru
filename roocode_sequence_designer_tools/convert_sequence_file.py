...
import sys
import argparse
from roocode_sequence_designer_tools.converters.convert_to_ball import convert_word_flash_to_ball
from roocode_sequence_designer_tools.converters.convert_ball_to_seqdesign import convert_ball_to_seqdesign
from roocode_sequence_designer_tools.converters.convert_lyrics_to_ball import convert_lyrics_to_ball
...
def main():
    ...
    if input_ext == '.json' and 'word_flash_sequence' in args.input_file and output_ext == '.json':
        convert_word_flash_to_ball(args.input_file, args.output_file)
    
    # Convert .ball.json to .seqdesign.json
    elif input_ext == '.json' and output_ext == '.json' and '.ball' in args.input_file and '.seqdesign' in args.output_file:
        convert_ball_to_seqdesign(args.input_file, args.output_file)
    
    # Convert .lyrics.json to .ball.json
    elif input_ext == '.json' and 'lyrics_timestamps' in args.input_file and output_ext == '.json':
        try:
