...
this version of prg_generator started undesired strobbing for some reason and so we fixed it by automatically adding gaps, but its a mess, we dont really need the gaps because we are using a version without undesired strobbing
