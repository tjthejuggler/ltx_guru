...
class LLMChatWindow(QWidget):
    ...
    def _create_system_message(self, selected_timelines):
        ...
        system_message += (
            ...
            "\n\nWhen calling these direct functions, ensure you provide ALL required arguments as specified in their descriptions. For example, `clear_timeline` requires the `timeline_index` parameter."
            ...
            "\n- Use execute_sequence_code for ALL other cases, especially when you need to:"
