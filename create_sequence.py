...
def create_test_sequence():
    ...
    data.extend(b'PI')
    # Simplified timing data - using pattern from colors.prg
    data.extend(b'\x87\x00\x00\x00\x07\x00\x03\x00\x64\x00')
    data.extend(b'\xa5\x00\x00\x00\x00\x00\x04\x00\x01\x00\x00\x2c\x01\x00\x00\x03\x00\x64\x00')
...
if __name__ == '__main__':
    ...
    # Write to file
    with open('sequences/test_red_blue.prg', 'wb') as f:
        f.write(sequence_data)
    
    print("Created test sequence file: test_red_blue.prg")
