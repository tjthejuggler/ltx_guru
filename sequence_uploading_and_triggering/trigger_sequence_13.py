...
# --- Configuration ---
BALL_IP = "192.168.40.205"  # <<<< YOUR BALL IP
PC_IP = ""
...
def stop_play_sequence(stop_op_id_byte):
    ball_status, sniffed_cmd_byte2, _, _ = sniff_ball_udp_status()
    ...
    print(f"Sending Stop Command (Op ID: {stop_op_id_byte:02x}, CmdByte2 {command_byte2_to_use:02x}). Payload: {payload.hex()}")
